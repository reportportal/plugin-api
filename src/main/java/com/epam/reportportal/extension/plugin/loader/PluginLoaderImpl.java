...
package com.epam.reportportal.extension.plugin.loader;

import com.epam.reportportal.extension.common.ExtensionPoint;
import com.epam.reportportal.extension.common.IntegrationTypeBuilder;
...
public class PluginLoaderImpl implements PluginLoader {
	...
	private final RpManifestPluginDescriptorFinder rpManifestPluginDescriptorFinder;

	@Autowired
	public PluginLoaderImpl(@Value("${rp.plugins.resolved.path}") String pluginsRootPath, DataStore dataStore,
			IntegrationTypeRepository integrationTypeRepository, RpManifestPluginDescriptorFinder rpManifestPluginDescriptorFinder) {
		this.pluginsRootPath = pluginsRootPath;
		this.dataStore = dataStore;
		this.integrationTypeRepository = integrationTypeRepository;
		this.rpManifestPluginDescriptorFinder = rpManifestPluginDescriptorFinder;
	}

	@Override
	@NotNull
	public PluginInfo extractPluginInfo(Path pluginPath) throws PluginException {
		RpPluginDescriptor pluginDescriptor = rpManifestPluginDescriptorFinder.find(pluginPath);
		return new PluginInfo(pluginDescriptor.getPluginId(), pluginDescriptor.getVersion(), pluginDescriptor.getService());
	}
	...
	public IntegrationType retrieveIntegrationType(PluginInfo pluginInfo) {
		...
		IntegrationTypeProperties.SERVICE.setValue(integrationType.getDetails(), pluginInfo.getService());
