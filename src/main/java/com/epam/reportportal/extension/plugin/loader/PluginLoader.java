...
public interface PluginLoader {
	...
	/**
	 * Remove the plugin file from the temporary directory and file name from the {@link com.epam.reportportal.extension.plugin.manager.Pf4jPluginManager#uploadingPlugins}
	 *
