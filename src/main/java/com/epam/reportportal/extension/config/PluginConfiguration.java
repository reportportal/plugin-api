...
import com.epam.reportportal.extension.plugin.manager.ReportPortalExtensionFactory;
...
public class PluginConfiguration {
	...
	@Value("${rp.plugins.service}")
	private String pluginService;

	@Bean
	public Pf4jPluginBox pf4jPluginBox() throws IOException {
		Pf4jPluginManager manager = new Pf4jPluginManager(pluginService,
				pluginsPath,
				pluginsTempPath,
				resourcesDir,
				pluginLoader,
	...
	@Bean
	public RpManifestPluginDescriptorFinder rpManifestPluginDescriptorFinder() {
		return new RpManifestPluginDescriptorFinder();
	}
